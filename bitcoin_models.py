...
numeric_columns = bitcoin_database_open_date.select_dtypes(include=['float64', 'int64']).columns

# Group data by quarters and calculate the mean for each quarter
grouped_data = bitcoin_database_open_date.groupby('quarter')[numeric_columns].mean().reset_index()
